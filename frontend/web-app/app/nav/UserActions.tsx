...
import { AiFillCar, AiFillTrophy, AiOutlineLayout } from 'react-icons/ai'
...
export default function UserActions({ user }: Props) {
    ...
    return (
        <Dropdown label={`Welcome ${user.name}`}>
            <Dropdown.Item icon={HiUser} onClick={setSeller}><Link href='/'>My Auctions</Link></Dropdown.Item>
            ...
            <Dropdown.Divider><Dropdown.Item icon={AiOutlineLayout} onClick={() => signOut({ callbackUrl: '/' })}>Sign out</Dropdown.Item></Dropdown.Divider>
        </Dropdown>
    )
}
