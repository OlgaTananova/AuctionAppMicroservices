...
import { getBidsForAuction } from '../actions/auctionAction'
...
export default function BidList({ user, auction }: Props) {
    ...
    const highBid = bids.reduce((prev, curr) =>
        prev > curr.amount
            ? prev
            : curr.bidStatus.includes("Accepted") ? curr.amount : prev, 0
    )
        ...
        <div className='rounded-lg shadow-md'>
            <div className='py-2 px-4 bg-white'>
                <div className='sticky top-0 bg-white p-2'>
                    <Heading title={`Current high bid is $${highBid}`}></Heading>
                </div>
            </div>
            ...
            <div className='px-2 pb-2 text-gray-500'>
                {!open ? (<div className='flex items-center justify-center p-2 text-lg font-semibold'>
                    ...
                    : !user ? (
                        ...
                        <BidForm auctionId={auction.id} highBid={highBid}></BidForm>
                    )}
            </div>
