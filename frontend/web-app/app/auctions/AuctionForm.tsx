...
import { createAuction, updateAuction, updateAuctionTest } from '../actions/auctionAction';
    ...
    return (
        <form className='flex flex-col mt-3' onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className='grid grid-cols-2 gap-3'>
                ...
                <Input label="Mileage" name='milage' control={control} type='number' rules={{ required: "Mileage is required" }} />
            </div>
