...
{
    private readonly Mock<IAuctionRepositiory> _auctionRepo;
    ...
    public AuctionControllerTests()
    {
        ...
        _auctionRepo = new Mock<IAuctionRepositiory>();
    ...
    public async Task UpdateAuction_WithUpdateAuctionDto_ReturnsOkResponse()
    {
        ...
        Auction auction = _fixture.Build<Auction>().Without(x => x.Item).Create();
        auction.Item = _fixture.Build<Item>().Without(x => x.Auction).Create();
        auction.Seller = "test";

        UpdateAuctionDto updatedDto = _fixture.Create<UpdateAuctionDto>();
